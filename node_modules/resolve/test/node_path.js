...
test('$NODE_PATH', function (t) {
    ...
    resolve('aaa', {
        ...
        t.equal(res, path.join(__dirname, '/node_path/x/aaa/post.js'));
    });
    ...
    resolve('bbb', {
        ...
        t.equal(res, path.join(__dirname, '/node_path/y/bbb/post.js'));
    });
    ...
    resolve('ccc', {
        ...
        t.equal(res, path.join(__dirname, '/node_path/x/ccc/post.js'));
    });
